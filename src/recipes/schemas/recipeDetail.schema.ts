...
export type RecipeDocument = HydratedDocument<RecipeDetail>;
...
export class RecipeDetail {
  ...
  @ApiProperty({
    description: 'The flag to check recipe is saved or not',
    example: true,
  })
  @IsNotEmpty()
  @IsBoolean()
...
export const RecipeDetailSchema = SchemaFactory.createForClass(RecipeDetail);
